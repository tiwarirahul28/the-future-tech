        ...
        <section class="about">
            <div class="row">
                <div class="about-col">
                    ...
                    <p>Participants will be able to learn about the latest technologies and trends in the field of technology, as well as develop their skills and knowledge by taking part in these exciting competitions. The goal of these competitions is to help participants gain a better understanding of the various aspects of technology and how they can apply it to their own projects. By taking part in such events, participants will be able to hone their skills and learn more about different technologies that can help them succeed in their chosen career paths.</p>
                </div>
                {/* <div class="about-col">
                    <img src={AboutUsImg} alt="about-us-img"/>
                </div> */}
